package com.development.mydaggerhiltmvvm.util.tooltip
...
class TooltipLayout : FrameLayout {
    ...
    private fun applyAttrs(context: Context, @Nullable builder: TooltipBuilder?) {
        ...
        layoutRes = R.layout.tutorial_view
        textColor = Color.WHITE
        titleTextColor = Color.WHITE
        textTitleSize = resources.getDimension(R.dimen.title_size)
        textSize = resources.getDimension(R.dimen.text_normal)
        shadowColor = ContextCompat.getColor(context, R.color.shadow)
        spacing = resources.getDimension(R.dimen.spacing_normal).toInt()
        arrowMargin = spacing / 3
        arrowWidth = (1.5 * spacing).toInt()
        backgroundContentColor = Color.BLACK
        circleBackgroundDrawableRes = R.drawable.selector_circle
        prevString = getContext().getString(R.string.previous)
        nextString = getContext().getString(R.string.next)
        finishString = getContext().getString(R.string.finish)
        skipString = getContext().getString(R.string.skip)
        prevDrawableRes = R.drawable.ic_left_arrow
        nextDrawableRes = R.drawable.ic_right_arrow
        lineWidthRes = resources.getDimension(R.dimen.line_width).toInt()
        lineColorRes = ContextCompat.getColor(context, R.color.line_color)
        tooltipRadius = resources.getDimension(R.dimen.tooltip_radius).toInt()
